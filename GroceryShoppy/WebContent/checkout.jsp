...
<%
	...
	//List<Cart>     mycart  =  cdao.getMyCartByEmai(request.getSession().getAttribute("sesemail").toString());
	List<Cart>     mycart = cdao.getMyCart();
	request.setAttribute("mycart", mycart);
	int pro_serial_number = 1;
...
<html lang="zxx">
<head>
	<title>Grocery Shoppy :: Checkout</title>
	<!--/tags -->
...
<body>
		...
		<div class="container">
			...
			<div class="checkout-right">
				<h4>Your shopping cart contains:
					<span><%=mycart.size() %> Products</span>
				</h4>
				<div class="table-responsive">
					<table class="timetable_sub">
						...
						<tbody><%pro_serial_number=1;%>
							<c:forEach items="${mycart}" var="i">
							<tr class="rem<%=pro_serial_number%>">
								<td class="invert"><%=pro_serial_number%></td>
								<td class="invert-image">
									<a href="single2.html">
										<img src="images/${i.pImage}.jpg" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
								...
								<td class="invert">${i.pName}</td>
								<td class="invert">PKR ${i.price}</td>
								<td class="invert">
									<div class="rem">
										<div class="proclose<%=pro_serial_number%>" onclick="deleteProductFromCart(${i.id})"> </div>
									</div>
								</td>
							</tr><%pro_serial_number++;%>
							</c:forEach>
						</tbody>
						<tfoot>
							<td colspan="2"></td>
							<td >Total 22 Units</td>
							<td ></td>
			...
			<div class="checkout-left">
				<div class="address_form_agile">
					...
					<form action="OrderPlaceController" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls">
										<input class="billing-address-name" type="text" name="fname" placeholder="Full Name" required="">
									</div>
									...
									<%}else{ %>
									<div class="controls">
										<input class="billing-address-name" value="<%=session.getAttribute("useremail")%>" type="email" name="email" placeholder="Email" readonly>
									</div>
									<%} %>
									...
									<div class="controls">
										<select class="option-w3ls" name="addtype">
	...
	<script>
		$(document).ready(function (c) {
			$('.proclose<%=pro_serial_number%>').on('click', function (c) {
				$('.rem<%=pro_serial_number%>').fadeOut('slow', function (c) {
					$('.rem<%=pro_serial_number%>').remove();
				});
			});
		});
	</script>
	...
	<script type="text/javascript">
		function deleteProductFromCart(id){
			console.log("deletetocart  Working Here");
			console.log(id);
			$.ajax({
				type:"POST",
