...
<%ProductDAO         pdao   = new ProductImplement();
 // Product singlePro = pdao.getProductByName("Lays Potato Chips");
  Product singlePro = pdao.getProductByName(request.getParameter("pname"));
  request.setAttribute("spro", singlePro);
%>
<head>
	<title>Grocery Shoppy :: ${spro.name}</title>
	<!--/tags -->
...
<body>
	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Description
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/${spro.imgs1}.jpg">
								<div class="thumb-image">
									<img src="images/${spro.imgs1}.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="images/${spro.imgs2}.jpg">
								<div class="thumb-image">
									<img src="images/${spro.imgs2}.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="images/${spro.imgs3}.jpg">
								<div class="thumb-image">
									<img src="images/${spro.imgs3}.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<p>
					<span class="item_price">PKR ${spro.price}</span>
					<del>PKR ${spro.extraprice}</del>
				...
				<div class="single-infoagile">
					<ul>
						...
						<li>
							Sold for
							<span class="item_price">95</span> times
						</li>
					</ul>
				</div>
				<div class="product-single-w3l">
					...
					<ul>
						<c:forEach items="${spro.desVal}" var="d">
						<li>
							${d}
						</li>
						</c:forEach>
					...
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
						<form action="#" method="post">
							<fieldset>
								...
								<input type="hidden" name="item_name" value="${spro.name}" />
								<input type="hidden" name="amount" value="${spro.price}" />
