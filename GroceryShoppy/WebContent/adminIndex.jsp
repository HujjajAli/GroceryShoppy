...
<!--button css-->
<link href="adminfront/css/demo-page.css" rel="stylesheet" media="all">
<link href="adminfront/css/hover.css" rel="stylesheet" media="all">
<!--static chart-->
<script src="adminfront/js/Chart.min.js"></script>
<!--//charts-->
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="adminfront/js/chartinator.js" ></script>
...
<!--skycons-icons-->
<script src="adminfront/js/skycons.js"></script>
<!--//skycons-icons-->
								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="adminfront/images/p4.png" alt=""></div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img src="adminfront/images/p2.png" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img src="adminfront/images/p3.png" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img src="adminfront/images/p5.png" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img src="adminfront/images/p6.png" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img src="adminfront/images/p7.png" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="adminfront/images/p1.png" alt=""> </span> 
												<div class="user-name">
													<p>Hujaj Ali</p>
                            ...
                            <div class="table-responsive">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a href="#" class="btn hvr-radial-out">View</a></td>
                              </tr>
                              </c:forEach>
                              <!-- Costumer Data End -->
                          </tbody>
