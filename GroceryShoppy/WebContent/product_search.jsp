...
Solution for future checkout problem just changed checkout.html in minicart to checkout.jsp
-->
<html lang="zxx">
<% 
...
%>
<head>
	<title>Grocery Shoppy  :: Products Find</title>
	<!--/tags -->
...
<body>
		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-8 header">
				...
				<ul>
					...
					<li>
						<span class="fa fa-phone" aria-hidden="true"></span> +923 333 3706512
					</li>
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal1">
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">10 Results Found
			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
				<div class="wrapper">
					...
					<c:forEach items="${searched_products}" var="p">
